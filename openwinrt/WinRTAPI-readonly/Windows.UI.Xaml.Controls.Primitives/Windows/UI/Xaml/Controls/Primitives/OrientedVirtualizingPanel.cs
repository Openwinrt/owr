namespace Windows.UI.Xaml.Controls.Primitives
{
    ...
    [Version(0x6020000), WebHostHidden, Composable(typeof(IOrientedVirtualizingPanelFactory), CompositionType.Public, 0x6020000), MarshalingBehavior(MarshalingType.FreeThreaded), Threading(ThreadingModel.Both)]
    public class OrientedVirtualizingPanel : VirtualizingPanel, IOrientedVirtualizingPanel, IScrollInfo, IScrollSnapPointsInfo
    {
