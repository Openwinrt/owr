namespace Windows.Security.Authentication.OnlineId
{
    ...
    public sealed class UserAuthenticationOperation : IAsyncOperation<UserIdentity>, IAsyncInfo
    {
        ...
        public AsyncOperationCompletedHandler<UserIdentity> Completed { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; [param: In] [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] set; }
