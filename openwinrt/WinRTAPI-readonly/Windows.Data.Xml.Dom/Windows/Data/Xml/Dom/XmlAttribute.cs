namespace Windows.Data.Xml.Dom
{
    ...
    public sealed class XmlAttribute : IXmlAttribute, IXmlNode, IXmlNodeSelector, IXmlNodeSerializer
    {
        ...
        public bool Specified { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
        ...
        public string Windows.Data.Xml.Dom.IXmlAttribute.Name { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }

        public bool Windows.Data.Xml.Dom.IXmlAttribute.Specified { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }

        public string Windows.Data.Xml.Dom.IXmlAttribute.Value { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; [param: In] [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] set; }
