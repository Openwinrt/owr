namespace Windows.Devices.Sms
{
    ...
    public sealed class GetSmsMessageOperation : IAsyncOperation<ISmsMessage>, IAsyncInfo
    {
        ...
        public AsyncOperationCompletedHandler<ISmsMessage> Completed { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; [param: In] [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] set; }
