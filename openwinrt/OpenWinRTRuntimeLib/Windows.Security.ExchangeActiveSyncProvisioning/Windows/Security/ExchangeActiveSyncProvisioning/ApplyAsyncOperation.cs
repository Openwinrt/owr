namespace Windows.Security.ExchangeActiveSyncProvisioning
{
    ...
    [Version(0x6020000)]
    public sealed class ApplyAsyncOperation : IAsyncOperation<EasComplianceResults>, IAsyncInfo
    {
        ...
        public void Close();
        [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)]
        public EasComplianceResults GetResults();

        public AsyncOperationCompletedHandler<EasComplianceResults> Completed { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; [param: In] [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] set; }
