namespace Windows.Security.Credentials.UI
{
    ...
    public sealed class CredentialPickerOperation : IAsyncOperation<CredentialPickerResults>, IAsyncInfo
    {
        ...
        public void Close();
        [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)]
        public CredentialPickerResults GetResults();

        public AsyncOperationCompletedHandler<CredentialPickerResults> Completed { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; [param: In] [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] set; }
