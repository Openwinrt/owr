namespace Windows.Data.Xml.Dom
{
    ...
    public sealed class XmlProcessingInstruction : IXmlProcessingInstruction, IXmlNode, IXmlNodeSelector, IXmlNodeSerializer
    {
        ...
        public string Target { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
        ...
        public string Windows.Data.Xml.Dom.IXmlProcessingInstruction.Data { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; [param: In] [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] set; }

        public string Windows.Data.Xml.Dom.IXmlProcessingInstruction.Target { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
    }
}
