namespace Windows.Globalization.NumberFormatting
{
    ...
    [Activatable(typeof(IPermilleFormatterFactory), 0x6020000), MarshalingBehavior(MarshalingType.FreeThreaded), Version(0x6020000), Activatable(0x6020000), DualApiPartition(version=0x6020000), Threading(ThreadingModel.Both)]
    public sealed class PermilleFormatter : INumberFormatterOptions, INumberFormatter, INumberParser
    {
        ...
        [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)]
        public PermilleFormatter([In] IIterable<string> languages, [In] string geographicRegion);
        [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime), DefaultOverload, Overload("FormatDouble")]
