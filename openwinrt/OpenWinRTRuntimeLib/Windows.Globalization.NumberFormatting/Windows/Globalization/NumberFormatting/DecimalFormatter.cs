namespace Windows.Globalization.NumberFormatting
{
    ...
    [Version(0x6020000), MarshalingBehavior(MarshalingType.FreeThreaded), Activatable(typeof(IDecimalFormatterFactory), 0x6020000), DualApiPartition(version=0x6020000), Activatable(0x6020000), Threading(ThreadingModel.Both)]
    public sealed class DecimalFormatter : INumberFormatterOptions, INumberFormatter, INumberParser
    {
        [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)]
        public DecimalFormatter();
        [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)]
        public DecimalFormatter([In] IIterable<string> languages, [In] string geographicRegion);
