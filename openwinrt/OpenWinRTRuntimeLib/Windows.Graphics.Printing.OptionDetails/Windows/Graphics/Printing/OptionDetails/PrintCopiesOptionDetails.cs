namespace Windows.Graphics.Printing.OptionDetails
{
    ...
    public sealed class PrintCopiesOptionDetails : IPrintOptionDetails, IPrintNumberOptionDetails
    {
        ...
        public uint MaxValue { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }

        public uint MinValue { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
        ...
        public uint Windows.Graphics.Printing.OptionDetails.IPrintNumberOptionDetails.MaxValue { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }

        public uint Windows.Graphics.Printing.OptionDetails.IPrintNumberOptionDetails.MinValue { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
