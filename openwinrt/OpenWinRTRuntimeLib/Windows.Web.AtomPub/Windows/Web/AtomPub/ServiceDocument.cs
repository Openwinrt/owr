namespace Windows.Web.AtomPub
{
    ...
    public sealed class ServiceDocument : IServiceDocument, ISyndicationNode
    {
        ...
        public IVectorView<Workspace> Windows.Web.AtomPub.IServiceDocument.Workspaces { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
        ...
        public IVectorView<Workspace> Workspaces { [MethodImpl(0, MethodCodeType=MethodCodeType.Runtime)] get; }
    }
}
